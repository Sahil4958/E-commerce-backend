...
const order_validate_1 = require("../validate/order.validate");
 ...
 */
orderRouter.post("/checkout", auth_middleware_1.authMiddleware, (0, validate_1.validate)({ body: order_validate_1.checkoutBody }), order_controller_1.checkoutFromCart);
/**
 * @swagger
 * /api/v1/orders:
 *   get:
 ...
 *         description: Unauthorized
 */
orderRouter.get("/", auth_middleware_1.authMiddleware, order_controller_1.getMyOrders);
/**
 * @swagger
 * /api/v1/orders/{id}:
 *   patch:
 ...
 */
orderRouter.patch("/:id", auth_middleware_1.authMiddleware, (0, validate_1.validate)({ body: order_validate_1.updateOrderBody }), order_controller_1.updateOrder);
/**
 * @swagger
 ...
 */
orderRouter.patch("/status/:id", auth_middleware_1.authMiddleware, adminValidate_middleware_1.authorization, (0, validate_1.validate)({ body: order_validate_1.updateOrderStatusBody }), order_controller_1.updateOrderStatus);
/**
 * @swagger
 ...
 *                   price: 500
 */
orderRouter.get("/products", auth_middleware_1.authMiddleware, order_controller_1.listOrderedProducts);
/**
 * @swagger
 * /api/v1/orders/{id}:
 *   delete:
 ...
 */
orderRouter.delete("/:id", auth_middleware_1.authMiddleware, order_controller_1.cancelOrder);
/**
 * @swagger
 ...
 */
orderRouter.get("/expenses", auth_middleware_1.authMiddleware, (0, validate_1.validateQuery)(order_validate_1.expensesQuery), order_controller_1.totalExpenses);
/**
 * @swagger
 * /api/v1/orders/{id}:
 *   get:
 ...
 *         description: Unauthorized
 */
orderRouter.get("/:id", auth_middleware_1.authMiddleware, order_controller_1.getOrder);
